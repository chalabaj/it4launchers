...
nsample=12	            # number of trajectories
...
submit="qsub" # comment this line if you don't want to submit to queue yet
...
#!/bin/bash
#PBS -q $queue
#PBS -l select=1:ncpus=24:mpiprocs=4:mem=${mem}gb:ompthreads=1
...
#!/bin/bash
#PBS -V
JOBNAME=ABIN_$molname_${i}_\${PBS_JOBID}
INPUTPARAM=input.in
INPUTGEOM=mini.dat
OUTPUT=output
TRAJ=$i
